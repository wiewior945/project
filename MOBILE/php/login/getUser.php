...
$res = mysqli_query($con, "SELECT Username,id FROM user WHERE Username='$username'") or die('Query failed: ' . mysql_error());

$result=array();
while($row=mysqli_fetch_array($res)){
array_push($result, array('username'=>$row[0], 'id'=>$row[1]));
}
